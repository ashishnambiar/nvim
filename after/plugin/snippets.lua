...
class _{}State extends State<{}> {{
  ...
  Widget build(BuildContext context) {{
    return {}{};
      ...
      { i(1, "default"), rep(1), rep(1), rep(1), rep(1), rep(1), c(2, { t "", t "Container()", t "Scaffold(body:)" }), i(0) })
  )
})
...
class {} extends StatelessWidget {{
  ...
  Widget build(BuildContext context) {{
    return {}{};
      ...
      { i(1, "name"), rep(1), c(2, { t "", t "Container()", t "Scaffold(body:)" }), i(0) })
  )
})
...
class {} with _${} {{
  ...
  factory {}.fromJson(Map<String, dynamic> json) =>
      ...
      { i(1, "name"), rep(1), rep(1), i(0), rep(1), rep(1), rep(1) })
  )
})
...
class {} with _${} {{
  const factory {}({{
    {}
      ...
      { i(1, "name"), rep(1), rep(1), i(0), rep(1) })
  )
})
